    ...
    if (user) {
        authLinks.innerHTML = `
            <div class="user-menu" style="display: flex; align-items: center; gap: 1.5rem;">
                <span class="user-name" style="font-weight: 600;">مرحباً، ${user.username}</span>
                ...
                <button onclick="logout()" class="nav-link" style="background: none; border: none; color: white; cursor: pointer; font-family: 'Cairo', sans-serif; font-weight: 600; font-size: 1rem;">
